...
final class MenuMigration extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function change(): void
    {
        ...
        if (!$table->hasColumn('vendor_id')) {
            $columnsToAdd['vendor_id'] = ['type' => 'integer', 'null' => true];
        }
        ...
        if (!$table->hasColumn('num_stores')) {
            $columnsToAdd['num_stores'] = ['type' => 'integer', 'null' => true];
        }
