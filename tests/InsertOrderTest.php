...
class InsertOrderTest extends BaseTest
{
    private $connection;
    ...
    public function testInsertOrder()
    {
        ...
        $stmt = $this->connection->prepare("insert into orders set agents_id = ?, vendors_id = ?, terminals_id = ?, orderReference = ?, subTotal = ?, tax = ?, total = ?, notes = ?, lastMod = ?, orderName = ?, employee_id = ?, OrderDate = ?, status = ?");
        $stmt->execute([
            $agents_id,
            $vendors_id,
            $data['termId'],
